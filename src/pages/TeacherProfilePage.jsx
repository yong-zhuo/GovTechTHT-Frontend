...
const TeacherProfilePage = () => {
  ...
  const { avgLastSemesterGPA, avgCumulativeGPA } = getTeacherAverageGpas(
    students,
    teacher,
    semesters
  )
  const teacherDetails = [
    {
      label: 'Average GPA of Students Last Semester',
      value: avgLastSemesterGPA,
    },
